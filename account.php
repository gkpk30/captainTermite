        ...
        $dbconn->connect();
            ...
            echo '<br/>
                <form method="POST" action = "signinfiltered.php">
                    ...
                    <label>Email<input type="email" id="email" name ="email" value="<?php echo $email;?>" /> </label><br/>
                    <label>Street Address<input type="address" id="address" name="address" value="<?php echo $address;?>/> </label><br/>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        echo
                            ...
                            echo '<a href="download.php?file=">Click to download your report</a>'
                        }
                    } else {
